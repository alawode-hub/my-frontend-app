          ...
          orders.map((order) => (
            <div key={order._id} style={{ border: "1px solid #333", padding: "1.5rem", marginBottom: "2rem", background: "#111" }}>
              ...
              <div style={{ marginBottom: "1.5rem" }}>
                <p style={{ fontSize: "0.75rem", fontWeight: "700", letterSpacing: "1.5px", marginBottom: "1rem", color: "#999" }}>
                  ITEMS ORDERED
                </p>
                {order.orderItems.map((item) => (
                  <div key={item._id} style={{ display: "flex", gap: "1rem", marginBottom: "1rem", paddingBottom: "1rem", borderBottom: "1px solid #222" }}>
                    <img
                      src={getFullImageUrl(item.image)}
                      alt={item.name}
                      loading="lazy"
                      style={{ width: "70px", height: "90px", objectFit: "cover", background: "#0a0a0a" }}
              ...
              <div style={{ borderTop: "2px solid #333", paddingTop: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
